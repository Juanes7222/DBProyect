...
class MinimumLengthValidator:
    ...
    def validate(self, password, user=None):
        if len(password) < self.min_length:
            raise ValidationError(
                ngettext(
                    "Esta contraseña es demasiado corta. Debe contener al menos "
                    "%(min_length)d caracteres.",
                    "Estas contraseñas son demasiado cortas. Deben contener al menos "
                    "%(min_length)d caracteres.",
                    self.min_length,
                ),
    ...
    def get_help_text(self):
        return ngettext(
            ...
            "Las contraseñas deben tener al menos %(min_length)d caracteres.",
            self.min_length,
        ...
        for attribute_name in self.user_attributes:
            ...
            for value_part in value_parts:
                ...
                if (
                    ...
                    raise ValidationError(
                        _("La contraseña es demasiado similar a la %(verbose_name)s."),
